...
COMMENT ON COLUMN activities.code IS 'React component code generated by Gemini 3.0 Flash';
...
-- ============================================================================
-- FEEDBACK ASSESSMENT & GENERATION (post-session loop)
-- See database/migrations/202605_feedback_agents.sql for the standalone migration.
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '📊 Tables created: 17 (incl. session capture + parent feedback)';
